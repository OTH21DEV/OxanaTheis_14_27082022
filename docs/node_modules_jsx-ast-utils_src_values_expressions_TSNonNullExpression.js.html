...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/jsx-ast-utils/src/values/expressions/TSNonNullExpression.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/jsx-ast-utils/src/values/expressions/TSNonNullExpression.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const extractValueFromThisExpression = require('./ThisExpression').default;
