...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/jsx-ast-utils/src/values/expressions/Identifier.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/jsx-ast-utils/src/values/expressions/Identifier.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const JS_RESERVED = {
  Array,
  Date,
  Infinity,
  Math,
