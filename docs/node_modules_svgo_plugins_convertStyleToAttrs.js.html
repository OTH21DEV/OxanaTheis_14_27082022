...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/svgo/plugins/convertStyleToAttrs.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/svgo/plugins/convertStyleToAttrs.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>/* jshint quotmark: false */
'use strict';
